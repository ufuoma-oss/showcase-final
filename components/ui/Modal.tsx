...
const Modal: React.FC<ModalProps> = ({ isOpen, onClose, title, children, size = 'md', footer }) => {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-end md:items-center justify-center bg-atelier-charcoal/80 backdrop-blur-sm transition-all duration-300 p-0 md:p-6">
      <div 
        className={`
            ...
            border border-atelier-charcoal/5 
      ...
      >
        ...
        <div className="flex justify-between items-center px-6 py-4 md:py-5 bg-white border-b border-gray-100 flex-shrink-0 z-10">
          <h2 className="text-lg md:text-xl font-display font-bold text-atelier-charcoal tracking-tight">{title}</h2>
